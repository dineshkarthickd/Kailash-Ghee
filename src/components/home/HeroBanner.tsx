    ...
    <div className="relative min-h-[90vh] flex items-center overflow-hidden pt-20 lg:pt-24 pb-12 bg-hero-gradient">
      ...
      <div className="w-full max-w-7xl mx-auto px-6 lg:px-16 relative z-10 flex flex-col lg:flex-row items-center h-full">
        ...
        >
          ...
          <h1
            className="text-4xl sm:text-5xl lg:text-[72px] font-heading font-normal text-primary leading-[1.2] lg:leading-[1.1] mb-6"
            dangerouslySetInnerHTML={{ __html: t('home.hero_title', 'Premium Organic Ghee.<br class="hidden sm:block" /> Handcrafted for Wellness.') }}
          />
